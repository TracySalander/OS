...
//Source code for character stack:
    //Our own exceptions
import CharStackException.CharStackEmptyException;
import CharStackException.CharStackFullException;
import CharStackException.CharStackInvalidAccessException;
import CharStackException.CharStackInvalidSizeException;
...
// Constructor with supplied size
    ...
    public static void push(char pcChar) throws CharStackFullException {
        ...
        aCharStack[++iTop] = pcChar;
           ...
           */
    public static char pop(char c) throws CharStackEmptyException {
        if (iTop == -1)
        throw new CharStackEmptyException();
